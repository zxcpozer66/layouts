const animals = [
  {
    ...
    description:
      "Любит пачкаться в грязи и есть бананы. Очень игривый и общительный.",
    points: [
  ...
  },
  {
    ...
    position: "Лев Симба",
    description:
      "Король саванны. Обладает величественной внешностью и спокойным характером.",
    points: [
  ...
  {
    image: "./img/животные/1.jpg",
    name: "Обезьяна Обыкновенная",
    position: "Обезьянка беличья",
    description: "Вид цепкохвостых обезьян из рода саймири.",
    points: ["Любит темноту", "Не ест с рук"],
  ...
  },
  {
    ...
    description:
      "Добродушный гигант с отличной памятью. Обожает водные процедуры.",
    points: [
  ...
  },
  {
    ...
    position: "Жираф Женя",
    description:
      "Самый высокий обитатель зоопарка. Имеет длинную шею и добрые глаза.",
    points: [
  ...
  },
  {
    ...
    width: "single", // Шестая карточка - одинарная
  },
];
